...
(function ($) {
  ...
  $(function () {
    ...
    $(document).ready(function () {
      // Gallery.
      $('body')
        .on('click', '.gallery a', function (event) {
        ...
        .on('click', '.gallery .modal', function (event) {
        ...
        .on('keypress', '.gallery .modal', function (event) {
        ...
        .on('mouseup mousedown mousemove', '.gallery .modal', function (event) {
